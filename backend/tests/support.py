    ...
    versions = [
        ...
        StrategyVersion(
            ...
            config_json={
                ...
                "plugin_config": {"timeframe": "5m", "lookback": 3, "breakout_pct": 0.0},
                "entry": {},
                "exit": {},
                "market": {"exchange": "UPBIT", "market_types": ["KRW"], "timeframes": ["5m"], "trade_basis": "candle"},
                "universe": {"mode": "static", "symbols": ["KRW-ETH"], "catalog_symbols": ["KRW-ETH"], "max_symbols": 1},
                "position": {"size_mode": "fixed_percent", "size_value": 0.1, "max_open_positions_per_symbol": 1, "max_concurrent_positions": 1},
                "risk": {"daily_loss_limit_pct": 0.03, "max_strategy_drawdown_pct": 0.1, "kill_switch_enabled": True},
                "execution": {"entry_order_type": "market", "exit_order_type": "market", "fee_model": "per_fill"},
                "backtest": {"initial_capital": 1_000_000},
            },
