...
from .zenith_hazel_v1 import ZenithHazelV1Plugin

BUILTIN_STRATEGY_PLUGINS = (BreakoutV1Plugin(), SmcConfluenceV1Plugin(), ObFvgBullReclaimV1Plugin(), ZenithHazelV1Plugin())
